package com.example.jetictors.rxjavalearn.widgets;
...
public class CommonItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public CommonItemDecoration(Context context) {
        ...
        this.mDividerColor = Color.parseColor("#E4E7E7");
     ...
     */
    public CommonItemDecoration setOrientation(int orientation) {
     ...
     */
    public CommonItemDecoration setDividerHeight(int dividerHeight){
        if (dividerHeight <= 0){
            mDividerHeight = 1;
            return this;
        }
     ...
     * @param isShow 是否显示
     */
    public CommonItemDecoration setShowLastLine(boolean isShow){
     ...
     * @param dividerColor
     */
    public CommonItemDecoration setDividerColor(int dividerColor){
        if (dividerColor == -1){
            this.mDividerColor =  Color.parseColor("#E4E7E7");
            return this;
        }
